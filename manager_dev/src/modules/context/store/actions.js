...
const actions = {
  ...
  async update({
    ...
    this.dispatch('preloader/fetch', true);
    const data = requestDataHandler('PUT', `/contexts/update/${payload.params.id}`, payload.body);
  ...
  async remove({
    ...
    this.dispatch('preloader/fetch', true);
    const data = requestDataHandler('DELETE', `/contexts/remove/${payload.params.id}`, payload.body);
