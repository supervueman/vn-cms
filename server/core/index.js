...
module.exports = async (app) => {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    const swaggerSpec = swaggerJSDoc({
      ...
      apis: ['./components/user/model/index.js', './components/user/routes/index.js', './components/role/model/index.js', './components/role/routes/index.js', './components/systemsetting/model/index.js', './components/systemsetting/routes/index.js']
    });
